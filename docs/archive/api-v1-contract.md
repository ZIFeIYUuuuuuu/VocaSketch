...
> Status: archived v1 contract. The normal VocaSketch backend path is now `backend` `/api/v2`; this document is kept only for historical reference and rollback comparison.
