...
其实，我也看了其他许多优秀选手的参赛成果。我感觉更多的是对题目上理解的不同。就我而言，我最开始考虑的就是用前端canvas渲染一些线条，达到绘图的效果，但是我发现最终呈现的效果有点不尽人意，所以我就想如果效果要好，光靠自然语言是不行的，可能要依靠大模型，那既然用了大模型，用户到底怎么判断这是AI绘图还是AI生图呢。我就这个问题而言，我进行了一些思维的发散，觉得应该拆解图层，模拟人类在数位板上的绘画操作，先打草稿，再绘线，再上色，在阴影最后进行一些微调于是终得到了这个结果。
